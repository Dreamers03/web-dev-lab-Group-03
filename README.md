<img width="669" height="1043" alt="image" src="https://github.com/user-attachments/assets/7a30c667-c65e-4903-acf4-1b1b0ddf2661" /> 
Course: Web Development 
Project: Ardhi ICT Innovation Hub  
...
During this lab, we successfully:
 ...
 Created a well-structured HTML document using:
  ...
  -Included appropriate `<title>` and `<meta>` tags  

Developed a **4-page website**:
   Home (`index.html`)
About (`about.html`)
Contact (`contact.html`)
 External Links (`external.html`)
...
-Organized files into proper folder structure for clarity and maintainability



##  Challenges Faced
While working on this lab, we encountered:

Difficulty in correctly linking pages (relative paths)
Managing project folder structure
Ensuring images display properly (especially local vs online paths)
 Understanding how navigation works across multiple pages



## Screenshots
Screenshots of all pages (Home, About, Contact, External) are included in the `screenshots/` folder for reference.
